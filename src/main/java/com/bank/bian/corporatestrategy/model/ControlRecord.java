package com.bank.bian.corporatestrategy.model;
...
/**
 * The BIAN control record for this service domain: "Strategy Directive Strategy".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Direct) applied
 * to its asset type (Strategy Directive). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Strategy Directive Strategy";
